...
ENGINE.IRQ.MENU = $208B; 
ENGINE.IRQ.CHAIN = $209A; 
ENGINE.IRQ.GAMEPLAY = $209D; unused
ENGINE.SWAP_BUFFERS = $209E; 
ENGINE.GO_MENU_MODE = $20B2; 
MENU.OPTIONS.LO = $10; 
MENU.OPTIONS.HI = $11; 
MENU.OPEN = $12; 
MENU.SELECTION = $14; 
...
MENU.NEW = $20D0; unused
MENU.END = $20E1; 
MENU.SUBSCRIBE_INPUT = $20EC; unused
MENU.INTERPRET.EXIT = $2117; 
MENU.INTERPRET = $2118; 
MENU.INTERPRET.INSTRUCTION.LOOP = $213B; 
MENU.INTERPRET.INSTRUCTION.JUMP_TABLE = $214C; 
MENU.INTERPRET.INSTRUCTION.TEXT = $2164; 
MENU.INTERPRET.INSTRUCTION.TEXT.LOOP = $2176; 
MENU.INTERPRET.INSTRUCTION.TEXT.EXIT = $218C; 
MENU.INTERPRET.INSTRUCTION.ICON = $218D; 
MENU.INTERPRET.INSTRUCTION.CHOICE = $218E; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT = $219B; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT.ABORT = $21A9; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN = $21B0; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN.ABORT = $21BA; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN = $21C1; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN.ABORT = $21CB; 
MENU.INTERPRET.INSTRUCTION.BACKGROUND = $21D2; 
MENU.INTERPRET.NEXT_BYTE = $21D6; 
MENU.INTERPRET.NEXT_BYTE.EXIT = $21E1; 
MENU.INTERPRET.GO_POINTER = $21E2; 
MENU.INTERPRET.GO_POINTER.JUMP = $21EE; 
MENU.INTERPRET.ON_UP_PRESSED = $21F2; 
MENU.INTERPRET.ON_UP_PRESSED.EXIT = $21FA; 
MENU.INTERPRET.ON_DOWN_PRESSED = $21FE; 
MENU.INTERPRET.ON_DOWN_PRESSED.EXIT = $220C; 
MENU.INTERPRET.ON_LEFT_PRESSED = $2210; 
MENU.INTERPRET.ON_LEFT_PRESSED.EXIT = $2218; 
MENU.INTERPRET.ON_RIGHT_PRESSED = $221C; 
MENU.INTERPRET.ON_RIGHT_PRESSED.EXIT = $222A; unused
MENU.INTERPRET.ON_FIRE_PRESSED = $222E; 
MENU.INTERPRET.CHANGE_CHOSEN = $2235; 
MENU.INTERPRET.CHANGE_CHOSEN.LOOP = $223D; 
MENU.INTERPRET.CHANGE_CHOSEN.EXIT = $2247; unused
MENU.FINALIZE_SELECTION = $224A; 
INPUT.JOY.IN = $20; 
INPUT.JOY.OLD = $21; 
INPUT.KEY.IN = $26; 
INPUT.KEY.OLD = $27; 
...
INPUT.JOY.RESET = $2251; 
INPUT.JOY.POLL = $2292; 
INPUT.JOY.TEST = $229E; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST = $22BA; 
INPUT.JOY.TEST.FIRE_TEST = $22C6; 
INPUT.JOY.TEST.UP_DOWN_TEST.RELEASE = $22CC; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST.RELEASE = $22D8; 
INPUT.JOY.TEST.FIRE_TEST.RELEASE = $22E4; 
INPUT.JOY.TEST.EXIT = $22EA; 
INPUT.JOY.TEST.UP = $22EB; 
INPUT.JOY.TEST.DOWN = $22F1; 
INPUT.JOY.TEST.RIGHT = $22F7; 
INPUT.JOY.TEST.LEFT = $22FD; 
INPUT.JOY.TEST.FIRE = $2303; 
INPUT.JOY.TEST.UP.RELEASE = $2309; 
INPUT.JOY.TEST.DOWN.RELEASE = $230F; 
INPUT.JOY.TEST.RIGHT.RELEASE = $2315; 
INPUT.JOY.TEST.LEFT.RELEASE = $231B; 
INPUT.JOY.TEST.FIRE.RELEASE = $2321; 
INPUT.KEY.POLL = $2327; 
INPUT.JOY.SUBSCRIBE.UP = $2334; 
INPUT.JOY.SUBSCRIBE.DOWN = $233B; 
INPUT.JOY.SUBSCRIBE.RIGHT = $2342; 
INPUT.JOY.SUBSCRIBE.LEFT = $2349; 
INPUT.JOY.SUBSCRIBE.FIRE = $2350; 
INPUT.JOY.SUBSCRIBE.UP.RELEASE = $2357; unused
INPUT.JOY.SUBSCRIBE.DOWN.RELEASE = $235E; unused
INPUT.JOY.SUBSCRIBE.RIGHT.RELEASE = $2365; unused
INPUT.JOY.SUBSCRIBE.LEFT.RELEASE = $236C; unused
INPUT.JOY.SUBSCRIBE.FIRE.RELEASE = $2373; unused
INPUT.DO_NOTHING = $237A; 
LOGIC.B = $30; 
LOGIC.SWITCH = $237B; 
LOGIC.SWITCH.JUMP = $2390; 
GRAPHICS.PUT_CHAR = $2394; 
GRAPHICS.PUT_CHAR.ADDRESS = $239D; 
GRAPHICS.PUT_COLOR = $23A1; 
GRAPHICS.PUT_COLOR.ADDRESS = $23AA; 
GRAPHICS.SET_CHAR_MULTICOLORS = $23AE; unused
MEMORY.FILL_PAGES = $23B8; unused
MEMORY.FILL_PAGES.LOOP = $23BD; 
MEMORY.FILL_PAGES.DONE = $23CC; 
MEMORY.COPY_PAGES = $23CD; 
MEMORY.COPY_PAGES.LOOP = $23D5; 
MEMORY.COPY_PAGES.DONE = $23EA; 
SCRIPT.REGISTER_LEVEL_LOOP = $23EB; unused
SCRIPT.REGISTER_MAIN_LOOP = $23F2; unused
SCRIPT.MENU_START = $23F9; 
