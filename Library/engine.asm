...
ENGINE.GAME_LOOP = $2054; 
ENGINE.GAME_LOOP.RUN_LEVEL_SCRIPT = $206C; 
ENGINE.GAME_LOOP.MENU_LOOP = $2072; 
ENGINE.GAME_LOOP.RUN_MAIN_SCRIPT = $2072; 
ENGINE.RENDER_LOOP = $2079; 
ENGINE.COLOR_SWITCH = $2082; unused
ENGINE.BUFFER_DONE = $2082; unused
ENGINE.IRQ = $2089; 
ENGINE.IRQ.MENU = $208F; unused
ENGINE.IRQ.GAMEPLAY = $2092; 
ENGINE.IRQ.EXIT = $2095; 
ENGINE.IRQ.CHAIN = $20A4; 
ENGINE.SWAP_BUFFERS = $20A7; 
ENGINE.SWAP_BUFFERS.EXIT = $20B4; unused
MENU.OPTIONS = $08; 
MENU.OPTIONS_END = $09; 
MENU.TYPE = $0B; 
MENU.SELECTION = $0C; 
...
MENU.NEW_MENU = $20B5; unused
SCRIPT.REGISTER_LEVEL_LOOP = $20C0; unused
SCRIPT.REGISTER_MAIN_LOOP = $20C7; unused
SCRIPT.MENU_START = $20CE; 
