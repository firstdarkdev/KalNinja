...
MENU.INTERPRET.ON_DOWN_PRESSED.EXIT = $2220; 
MENU.INTERPRET.ON_LEFT_PRESSED = $2224; 
MENU.INTERPRET.ON_LEFT_PRESSED.EXIT = $222C; 
MENU.INTERPRET.ON_RIGHT_PRESSED = $2230; 
MENU.INTERPRET.ON_RIGHT_PRESSED.EXIT = $223B; 
MENU.INTERPRET.ON_FIRE_PRESSED = $223F; 
MENU.INTERPRET.CHANGE_CHOSEN = $2246; 
MENU.INTERPRET.CHANGE_CHOSEN.LOOP = $224E; 
MENU.INTERPRET.CHANGE_CHOSEN.EXIT = $2258; 
MENU.FINALIZE_SELECTION = $225B; 
INPUT.JOY.IN = $20; 
INPUT.JOY.OLD = $21; 
INPUT.KEY.IN = $26; 
INPUT.KEY.OLD = $27; 
...
INPUT.JOY.EVENTS.RESET = $2262; 
INPUT.JOY.POLL = $22A3; 
INPUT.JOY.TEST = $22B6; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST = $22D2; 
INPUT.JOY.TEST.FIRE_TEST = $22DE; 
INPUT.JOY.TEST.UP_DOWN_TEST.RELEASE = $22E4; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST.RELEASE = $22F0; 
INPUT.JOY.TEST.FIRE_TEST.RELEASE = $22FC; 
INPUT.JOY.TEST.EXIT = $2302; 
INPUT.JOY.TEST.UP = $2303; 
INPUT.JOY.TEST.DOWN = $2309; 
INPUT.JOY.TEST.RIGHT = $230F; 
INPUT.JOY.TEST.LEFT = $2315; 
INPUT.JOY.TEST.FIRE = $231B; 
INPUT.JOY.TEST.UP.RELEASE = $2321; 
INPUT.JOY.TEST.DOWN.RELEASE = $2327; 
INPUT.JOY.TEST.RIGHT.RELEASE = $232D; 
INPUT.JOY.TEST.LEFT.RELEASE = $2333; 
INPUT.JOY.TEST.FIRE.RELEASE = $2339; 
INPUT.KEY.POLL = $233F; 
INPUT.JOY.SUBSCRIBE.UP = $234C; 
INPUT.JOY.SUBSCRIBE.DOWN = $2353; 
INPUT.JOY.SUBSCRIBE.RIGHT = $235A; 
INPUT.JOY.SUBSCRIBE.LEFT = $2361; 
INPUT.JOY.SUBSCRIBE.FIRE = $2368; 
INPUT.JOY.SUBSCRIBE.UP.RELEASE = $236F; unused
INPUT.JOY.SUBSCRIBE.DOWN.RELEASE = $2376; unused
INPUT.JOY.SUBSCRIBE.RIGHT.RELEASE = $237D; unused
INPUT.JOY.SUBSCRIBE.LEFT.RELEASE = $2384; unused
INPUT.JOY.SUBSCRIBE.FIRE.RELEASE = $238B; unused
INPUT.DO_NOTHING = $2392; 
GRAPHICS.PUT_CHAR = $2393; 
GRAPHICS.PUT_CHAR.ADDRESS = $239C; 
GRAPHICS.PUT_COLOR = $23A0; 
GRAPHICS.PUT_COLOR.ADDRESS = $23A9; 
GRAPHICS.SET_CHAR_MULTICOLORS = $23AD; unused
MEMORY.FILL_PAGES = $23B7; unused
MEMORY.FILL_PAGES.LOOP = $23BC; 
MEMORY.FILL_PAGES.DONE = $23CB; 
MEMORY.COPY_PAGES = $23CC; 
MEMORY.COPY_PAGES.LOOP = $23D4; 
MEMORY.COPY_PAGES.DONE = $23E9; 
SCRIPT.REGISTER_LEVEL_LOOP = $23EA; unused
SCRIPT.REGISTER_MAIN_LOOP = $23F1; unused
SCRIPT.MENU_START = $23F8; 
