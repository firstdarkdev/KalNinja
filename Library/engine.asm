...
ENGINE.KEY_IN = $08; 
ENGINE.JOY_IN = $09; 
ENGINE.BUFFER_SWITCH = $0B; 
ENGINE.CHAR_SWITCH = $0C; 
...
ENGINE.GAME_LOOP = $2046; 
ENGINE.GAME_LOOP.MENU = $205E; unused
ENGINE.GAME_LOOP.RUN_MENU_SCRIPT = $205E; 
ENGINE.GAME_LOOP.GAMEPLAY = $2064; 
ENGINE.GAME_LOOP.RUN_GAMEPLAY_SCRIPT = $2064; 
ENGINE.WAIT_TO_DRAW = $2067; 
ENGINE.RENDER_LOOP = $206B; 
ENGINE.COLOR_SWITCH = $2083; 
ENGINE.BUFFER_DONE = $2083; unused
ENGINE.IRQ = $208A; 
ENGINE.MENU = $2094; 
ENGINE.GAMEPLAY = $2097; 
ENGINE.IRQ.EXIT = $209A; 
...
MENU.TITLE = $01; 
MENU.CHOICE = $02; 
MENU.NEW_MENU = $20A7; unused
SCRIPT.REGISTER_GAMEPLAY_LOOP = $20B6; unused
SCRIPT.REGISTER_MENU_LOOP = $20BD; unused
SCRIPT.MENU_START = $20C4; 
