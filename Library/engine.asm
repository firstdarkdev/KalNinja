...
MENU.END = $20E5; unused
MENU.SUBSCRIBE_INPUT = $20F4; unused
MENU.INTERPRET = $211F; 
MENU.INTERPRET.INSTRUCTION.LOOP = $2142; 
MENU.INTERPRET.INSTRUCTION.JUMP = $215E; 
MENU.INTERPRET.EXIT = $2164; 
MENU.INTERPRET.INSTRUCTION.JUMP_TABLE = $2165; 
MENU.INTERPRET.INSTRUCTION.TEXT = $2181; 
MENU.INTERPRET.INSTRUCTION.TEXT.LOOP = $2193; 
MENU.INTERPRET.INSTRUCTION.TEXT.EXIT = $21A9; 
MENU.INTERPRET.INSTRUCTION.ICON = $21AA; 
MENU.INTERPRET.INSTRUCTION.CHOICE = $21AB; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT = $21B8; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT.ABORT = $21C6; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN = $21CD; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN.ABORT = $21D7; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN = $21DE; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN.ABORT = $21E8; 
MENU.INTERPRET.INSTRUCTION.BACKGROUND = $21EF; 
MENU.INTERPRET.NEXT_BYTE = $21F3; 
MENU.INTERPRET.NEXT_BYTE.EXIT = $21FE; 
MENU.INTERPRET.GO_POINTER = $21FF; 
MENU.INTERPRET.GO_POINTER.JUMP = $220B; 
MENU.INTERPRET.ON_UP_PRESSED = $220F; 
MENU.INTERPRET.ON_UP_PRESSED.EXIT = $2217; 
MENU.INTERPRET.ON_DOWN_PRESSED = $221B; 
MENU.INTERPRET.ON_DOWN_PRESSED.EXIT = $2226; 
MENU.INTERPRET.ON_LEFT_PRESSED = $222A; 
MENU.INTERPRET.ON_LEFT_PRESSED.EXIT = $2232; 
MENU.INTERPRET.ON_RIGHT_PRESSED = $2236; 
MENU.INTERPRET.ON_RIGHT_PRESSED.EXIT = $2241; 
MENU.INTERPRET.ON_FIRE_PRESSED = $2245; 
MENU.INTERPRET.CHANGE_CHOSEN = $224C; 
MENU.INTERPRET.CHANGE_CHOSEN.LOOP = $2254; 
MENU.INTERPRET.CHANGE_CHOSEN.EXIT = $225E; 
...
INPUT.JOY.EVENTS.RESET = $2268; 
INPUT.JOY.POLL = $22A9; 
INPUT.JOY.TEST = $22B8; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST = $22D4; 
INPUT.JOY.TEST.FIRE_TEST = $22E0; 
INPUT.JOY.TEST.UP_DOWN_TEST.RELEASE = $22E6; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST.RELEASE = $22F2; 
INPUT.JOY.TEST.FIRE_TEST.RELEASE = $22FE; 
INPUT.JOY.TEST.EXIT = $2304; 
INPUT.JOY.TEST.UP = $2305; 
INPUT.JOY.TEST.DOWN = $230B; 
INPUT.JOY.TEST.RIGHT = $2311; 
INPUT.JOY.TEST.LEFT = $2317; 
INPUT.JOY.TEST.FIRE = $231D; 
INPUT.JOY.TEST.UP.RELEASE = $2323; 
INPUT.JOY.TEST.DOWN.RELEASE = $2329; 
INPUT.JOY.TEST.RIGHT.RELEASE = $232F; 
INPUT.JOY.TEST.LEFT.RELEASE = $2335; 
INPUT.JOY.TEST.FIRE.RELEASE = $233B; 
INPUT.KEY.POLL = $2341; 
INPUT.JOY.SUBSCRIBE.UP = $234E; 
INPUT.JOY.SUBSCRIBE.DOWN = $2355; 
INPUT.JOY.SUBSCRIBE.RIGHT = $235C; 
INPUT.JOY.SUBSCRIBE.LEFT = $2363; 
INPUT.JOY.SUBSCRIBE.FIRE = $236A; 
INPUT.JOY.SUBSCRIBE.UP.RELEASE = $2371; unused
INPUT.JOY.SUBSCRIBE.DOWN.RELEASE = $2378; unused
INPUT.JOY.SUBSCRIBE.RIGHT.RELEASE = $237F; unused
INPUT.JOY.SUBSCRIBE.LEFT.RELEASE = $2386; unused
INPUT.JOY.SUBSCRIBE.FIRE.RELEASE = $238D; unused
INPUT.DO_NOTHING = $2394; 
GRAPHICS.PUT_CHAR = $2395; 
GRAPHICS.PUT_CHAR.ADDRESS = $239D; 
GRAPHICS.PUT_COLOR = $23A1; 
GRAPHICS.PUT_COLOR.ADDRESS = $23A9; 
MEMORY.FILL_PAGES = $23AD; unused
MEMORY.FILL_PAGES.LOOP = $23B2; 
MEMORY.FILL_PAGES.DONE = $23C1; 
MEMORY.COPY_PAGES = $23C2; 
MEMORY.COPY_PAGES.LOOP = $23CA; 
MEMORY.COPY_PAGES.DONE = $23DF; 
SCRIPT.REGISTER_LEVEL_LOOP = $23E0; unused
SCRIPT.REGISTER_MAIN_LOOP = $23E7; unused
SCRIPT.MENU_START = $23EE; 
