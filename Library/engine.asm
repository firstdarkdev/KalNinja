...
MENU.NEW = $20CA; unused
MENU.END = $20DF; unused
MENU.SUBSCRIBE_INPUT = $20E8; unused
MENU.INTERPRET.EXIT = $2115; 
MENU.INTERPRET = $2116; 
MENU.INTERPRET.INSTRUCTION.LOOP = $2139; 
MENU.INTERPRET.INSTRUCTION.JUMP = $2155; 
MENU.INTERPRET.INSTRUCTION.JUMP_TABLE = $215B; 
MENU.INTERPRET.INSTRUCTION.TEXT = $217B; 
MENU.INTERPRET.INSTRUCTION.TEXT.LOOP = $218D; 
MENU.INTERPRET.INSTRUCTION.TEXT.EXIT = $21A3; 
MENU.INTERPRET.INSTRUCTION.ICON = $21A4; 
MENU.INTERPRET.INSTRUCTION.CHOICE = $21A5; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT = $21B2; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_SELECT.ABORT = $21C0; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN = $21C7; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_CHOSEN.ABORT = $21D1; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN = $21D8; 
MENU.INTERPRET.INSTRUCTION.CHOICE.ON_NOT_CHOSEN.ABORT = $21E2; 
MENU.INTERPRET.INSTRUCTION.BACKGROUND = $21E9; 
MENU.INTERPRET.NEXT_BYTE = $21ED; 
MENU.INTERPRET.NEXT_BYTE.EXIT = $21F8; 
MENU.INTERPRET.GO_POINTER = $21F9; 
MENU.INTERPRET.GO_POINTER.JUMP = $2205; 
MENU.INTERPRET.ON_UP_PRESSED = $2209; 
MENU.INTERPRET.ON_UP_PRESSED.EXIT = $2211; 
MENU.INTERPRET.ON_DOWN_PRESSED = $2215; 
MENU.INTERPRET.ON_DOWN_PRESSED.EXIT = $2223; 
MENU.INTERPRET.ON_LEFT_PRESSED = $2227; 
MENU.INTERPRET.ON_LEFT_PRESSED.EXIT = $222F; 
MENU.INTERPRET.ON_RIGHT_PRESSED = $2233; 
MENU.INTERPRET.ON_RIGHT_PRESSED.EXIT = $2241; unused
MENU.INTERPRET.ON_FIRE_PRESSED = $2245; 
MENU.INTERPRET.CHANGE_CHOSEN = $224C; 
MENU.INTERPRET.CHANGE_CHOSEN.LOOP = $2254; 
MENU.INTERPRET.CHANGE_CHOSEN.EXIT = $225E; unused
MENU.FINALIZE_SELECTION = $2261; 
INPUT.JOY.IN = $20; 
INPUT.JOY.OLD = $21; 
INPUT.KEY.IN = $26; 
INPUT.KEY.OLD = $27; 
...
INPUT.JOY.RESET = $2268; 
INPUT.JOY.POLL = $22A9; 
INPUT.JOY.TEST = $22B5; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST = $22D1; 
INPUT.JOY.TEST.FIRE_TEST = $22DD; 
INPUT.JOY.TEST.UP_DOWN_TEST.RELEASE = $22E3; 
INPUT.JOY.TEST.RIGHT_LEFT_TEST.RELEASE = $22EF; 
INPUT.JOY.TEST.FIRE_TEST.RELEASE = $22FB; 
INPUT.JOY.TEST.EXIT = $2301; 
INPUT.JOY.TEST.UP = $2302; 
INPUT.JOY.TEST.DOWN = $2308; 
INPUT.JOY.TEST.RIGHT = $230E; 
INPUT.JOY.TEST.LEFT = $2314; 
INPUT.JOY.TEST.FIRE = $231A; 
INPUT.JOY.TEST.UP.RELEASE = $2320; 
INPUT.JOY.TEST.DOWN.RELEASE = $2326; 
INPUT.JOY.TEST.RIGHT.RELEASE = $232C; 
INPUT.JOY.TEST.LEFT.RELEASE = $2332; 
INPUT.JOY.TEST.FIRE.RELEASE = $2338; 
INPUT.KEY.POLL = $233E; 
INPUT.JOY.SUBSCRIBE.UP = $234B; 
INPUT.JOY.SUBSCRIBE.DOWN = $2352; 
INPUT.JOY.SUBSCRIBE.RIGHT = $2359; 
INPUT.JOY.SUBSCRIBE.LEFT = $2360; 
INPUT.JOY.SUBSCRIBE.FIRE = $2367; 
INPUT.JOY.SUBSCRIBE.UP.RELEASE = $236E; unused
INPUT.JOY.SUBSCRIBE.DOWN.RELEASE = $2375; unused
INPUT.JOY.SUBSCRIBE.RIGHT.RELEASE = $237C; unused
INPUT.JOY.SUBSCRIBE.LEFT.RELEASE = $2383; unused
INPUT.JOY.SUBSCRIBE.FIRE.RELEASE = $238A; unused
INPUT.DO_NOTHING = $2391; 
...
MEMORY.FILL_PAGES = $23B6; unused
MEMORY.FILL_PAGES.LOOP = $23BB; 
MEMORY.FILL_PAGES.DONE = $23CA; 
MEMORY.COPY_PAGES = $23CB; 
MEMORY.COPY_PAGES.LOOP = $23D3; 
MEMORY.COPY_PAGES.DONE = $23E8; 
SCRIPT.REGISTER_LEVEL_LOOP = $23E9; unused
SCRIPT.REGISTER_MAIN_LOOP = $23F0; unused
SCRIPT.MENU_START = $23F7; 
